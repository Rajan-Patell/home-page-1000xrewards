...
export const PaymentMethodsSection = () => {
  return (
    <section className="z-0 flex w-full items-center justify-between flex-wrap px-60 py-40 max-md:max-w-full max-md:px-5 max-md:py-[100px]">
      ...
      <div className="w-[460px] max-md:w-full flex justify-end">
        <img
          ...
          className="aspect-[1.07] object-contain max-w-full rounded-[0px_0px_0px_0px]"
        />
      </div>
    </section>
  );
