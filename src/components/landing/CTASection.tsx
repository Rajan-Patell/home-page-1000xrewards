export const CTASection = () => {
  return <section className="bg-[rgba(255,233,227,1)] z-0 flex w-full items-center gap-[40px_48px] justify-center flex-wrap py-40 max-md:max-w-full max-md:py-[100px] px-[24px]">
      ...
      <img src="https://cdn.builder.io/api/v1/image/assets/b50fe682d4084777a8c814359725a696/9664406657a35b6c81c5bc0779223ee63a5ce69f?placeholderIfAbsent=true" alt="Mega Rewards" className="aspect-[0.95] object-contain w-[613px] self-stretch min-w-60 my-auto max-md:max-w-full" />
    </section>;
};