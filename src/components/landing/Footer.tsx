...
export const Footer = () => {
  return (
    <footer className="bg-[rgba(255,226,217,1)] z-0 w-full p-16 max-md:px-5">
      <div className="max-w-[1440px] mx-auto flex min-h-[381px] items-stretch gap-[40px_48px] flex-wrap">
