...
export const FeaturesSection = () => {
  return (
    <section className="z-0 w-full px-8 py-20 md:p-40 lg:p-60 max-md:max-w-full">
      <h2 className="text-4xl md:text-6xl lg:text-[80px] font-bold tracking-[-1.6px] max-md:max-w-full">
        Why Choose
        <br />
        1000XRewards
      </h2>

      <div className="w-full mt-8 md:mt-12 max-md:max-w-full">
